    ...
    <div className="min-h-screen bg-background py-12 pt-24">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <Card>
            <CardHeader>
              <CardTitle className="text-3xl font-bold text-center">HAFTUNGSBESCHRÄNKUNG</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6 text-muted-foreground">
              <div>
                <h2 className="text-xl font-semibold mb-2 text-foreground">Haftung für Inhalte</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-semibold mb-2 text-foreground">Haftung für Links</h2>
                <p>
              ...
              <div>
                <h2 className="text-xl font-semibold mb-2 text-foreground">Urheberrecht</h2>
                <p>
...
export default Haftungsbeschraenkung;
